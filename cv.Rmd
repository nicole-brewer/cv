...
tribble(
  ...
  "Mathematics with Computer Science", "December 2018", "Purdue Univeristy", "West Lafayette, IN", list('Purdue’s All-Women Student Cluster Competition Team', 'Vice President of Purdue Triathlon Club')
) %>% 
...
tribble(
  ...
  'PEARC2018', 'Travel support to attend PEARC18 and attend the student program', 'XSEDE Student Travel Grant', 'XSEDE',
