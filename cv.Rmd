...
tribble( 
 ~ title, ~ role, ~ event, ~ place, ~ date, ~ url, ~ type,
 "Leveraging Traits for Highly Interactive Computational Tools in Jupyter", '\\underline{\\href{Abstract}{https://doi.org/10.5281/zenodo.5570605}', "Gateways 2021", "Virtual", 'July 2021', 'https://www.youtube.com/watch?v=O_KAupUYcyk', 'video',
 "Classification of Periodicity in Subtraction Game Sequences", "Poster", "PEARC18", "Pittsburg, PA", 'June 2018', 'https://doi.org/10.5281/zenodo.7133317', 'pdf'
 ) %>% 
  brief_entries(glue::glue('\\textbf{<title>} ({<role>}), <event>, <place>, (\\underline{\\href{<url>}{<type>}}).', .open = "<", .close = ">"), date, .protect = FALSE)
```
...
tribble(
 ...
 'https://nicole-brewer.github.io/long-tales-of-science/002/', 'episode'
   ...
   brief_entries(glue::glue('\\textbf{<title>} (<type>), <event>, <place>, (\\underline{\\href{<url>}{<format>}}.', .open = "<", .close = ">"), paste0(date, "\\newline"), .protect = FALSE)
```
