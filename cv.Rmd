...
tribble(
  ...
  'June 2023', 'Trainee', 'Carpentries Instructor Training', 'The Carpentries', 
  c('learned educational pedagogy to inform teaching practices and create accessible and inclusive workshops', 'obtained hands-on teaching practice helping others learn to code and work with data in a live setting'),
