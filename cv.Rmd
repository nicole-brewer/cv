...
tribble( 
 ~ title, ~ format, ~ event, ~ place, ~ date, ~ url, ~ additional,
 'Reproducing notebooks without (too much) effort', 'co-presenter', "US-RSE'24", "Albuquerque, NM", "Oct 2024", 'https://us-rse.org/usrse24/program/talks/', '',
...
tribble(
  ~Date, ~Position, ~Title, ~Institution, ~Desc,
    'Jan 2025 - May 2025', 'Co-Instructor and Curriculum Developer', 'Fundamentals in Research Software Engineering - Lab Secion', 'Complex Adaptive Systems', 'ASU',
  'July 2024', 'Lead Tutorial Instructor', '\\href{https://cfp.scipy.org/2024/talk/KAESWL/}{Building Complex Web Apps with Jupyter Widgets}', 'SciPy24, Tacoma, WA', 'https://github.com/Jupyter4Science/scipy2024-jupyter-widgets-tutorial', 
  'July 2023', 'Lead Tutorial Instructor', '\\href{https://cfp.scipy.org/2023/talk/NFWZXD/}{How the Little Jupyter Notebook Became a Web App}', 'SciPy23, Austin, TX', 'https://github.com/Jupyter4Science/scipy23-jupyter-widgets-tutorial',
...
tribble(
  ...
  'Jul 2024', '2023 BSSw Fellows: Projects and Perspectives', 'Better Scientific Software (BSSw)', 'https://bssw.io/blog_posts/2023-bssw-fellows-projects-and-perspectives',
  ...
  'Jun 2020', 'Who is Women in HPC: Panel Discussion', 'RCAC at Purdue', 'https://www.rcac.purdue.edu/news/1867',
...
```{r} 
  ...
  '2024', 'Reviewer', 'Curvenote-based Proceedings', 'SciPy',
  '2023', 'Reviewer', 'Tutorials and Digital Humanities Track', 'SciPy',
