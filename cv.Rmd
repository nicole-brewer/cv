...
tribble( 
 ...
 "Classification of Periodicity in Subtraction Game Sequences", "Poster", "PEARC18", "Pittsburg, PA", 'June 2018', 'https://doi.org/10.5281/zenodo.7133317', '.',
  ...
  brief_entries(glue::glue('\\textbf{<title>} (\\underline{\\href{<url>}{<format>}}), <event>, <place> <additional>', .open = "<", .close = ">"), date, .protect = FALSE)
```
...
tribble(
 ...
 'Reproducibility Challenge Committee', 'Member', 'Supercomputing', 'Dallas, TX',  'Nov 2022', '', #'https://se4science.org/workshops/se4escience22/schedule.htm',
   "Software Engineering Topics Relevant to eScience", "Invited Panelist", "eScience", "Salt Lake City, UT", "Oct 2022", '', #"https://us-rse.org/events/2021/2021-10-intnl-rse-day", 
  "How to Recruit and Sustain a Diverse and Inclusive Workforce: A Case Study",  "Invited Panelist", "International RSE Day Virtual Workshop", "Virtual", "Oct 2021", '(\\underscore\\href{https://doi.org/10.5281/zenodo.7133472}{slides}})',
) %>% 
  brief_entries(glue::glue('\\textbf{<Role>}, <Activity>, <Conference>. <Link>', .open = "<", .close = ">"), When, Conference, .protect = FALSE)
...
tribble(
 ...
 'https://nicole-brewer.github.io/long-tales-of-science/002/', 'episode'
   ...
   brief_entries(glue::glue('<title>,\\textbf{<type>}, <event>, <place>. (\\underline{\\href{<url>}{<format>}})', .open = "<", .close = ">"), date, .protect = FALSE)
```
...
tribble( 
 ~ title, ~ type, ~ year, ~url,
 'HPC Unplugged: A lesson plan for teaching parallel and distributed computing in middle school', 'Booklet', 'Sep 2022', 'https://www.nicole-brewer.com/hpc-unplugged/',
 ...
 "R for Research Scientists", "Booklet", 'Mar 2020', 'https://www.nicole-brewer.com/r-for-research-scientists/'
  ...
  brief_entries(glue::glue('\\textbf{<title>} (\\href{<url>}{<type>})', .open = "<", .close = ">"), year, .protect = FALSE)
```
