...
tribble(
  ...
  "PhD Computational History and Philosophy of Science", "Expected May 2027", "Arizona State University", "Tempe, AZ", c('Advisor: Manfred Laubichler'),
  "BS Mathematics with Computer Science", "December 2018", "Purdue Univeristy", "West Lafayette, IN", c(),
) %>% 
...
tribble(
 ...
 'Better Scientific Software Fellowship', 'Awardee', 'Up to $25,000', 'Exascale Computing Project (DOE/NSF)', 'Mar 2023 - Mar 2024',
)  %>% 
...
tribble( 
 ~ title, ~ format, ~ event, ~ place, ~ date, ~ url, ~ additional, 
   'Scientific Web Applications Template', 'presentation', 'RSE Comm. Call', 'Virtual', 'Mar 2022',
...
tribble(
  ...
  'Aug 2022 - Present', 'Graduate Research Assistant', 'Laubichler Lab, Arizona State University', c("Using natural language processing, machine learning, network analysis, high performance computing, and mixed social science methods to model the evolution of scientific standards through time", 'Documenting and adapting code and data from prior projects for reuse'),
  'June 2018 - Dec 2018', 'Student Cluster Competition, Reproducibility Challenge', 'Research Computing, Purdue University', list(
    'Advisor: Betsy Hillery', 'Built a small cluster and applied optimization techniques in a non-stop, 48-hour challenge at the SC18 conference', 'Compiled a scienfitic application from an accepted paper from the prior year’s Technical Program and interacted directly with the paper’s authors to reproduce specific results and conclusions from the paper'),
...
tribble(
  ...
  'US-RSE Booth', 'Coordinator', 'SC22', 'Dallas, TX', 'Nov 2022', '',
 'Reproducibility Challenge', 'Committee Member', 'SC22', 'Dallas, TX',  'Nov 2022', '', #'https://se4science.org/workshops/se4escience22/schedule.htm',
   "Software Engineering Topics Relevant to eScience", "Invited Panelist", "eScience22", "Salt Lake City, UT", "Oct 2022", '', #"https://us-rse.org/events/2021/2021-10-intnl-rse-day", 
  ...
  brief_entries(glue::glue('\\textbf{<Activity>}, <Role>. <Link>', .open = "<", .close = ">"), When, Conference, .protect = FALSE)
...
tribble(
 ...
 'Reproducibility Initiative at SC22', 'Host', 'Long Tales of Science', 'Podcast', 'Forthcoming', 'https://nicole-brewer.github.io/long-tales-of-science/004/', 'episode',
 ...
 'https://us-rse.org/2022-02-06-a-brief-history-of-usrse/', '',
...
tribble(
  ~Date, ~Position, ~Title, ~Institution, ~Desc,
  'Aug - Dec 2022', 'Curriculum Developer', 'Graduate Partners in Science Education: K - 12 STEM Education & Outreach', 'Arizona State University', 
...
```{r}
  tribble(
  ~Date, ~Position, ~Group,
  'Aug 2016 - May 2016', 'Vice President', 'Purdue University Triathlon Club', 
   'Aug 2015 - May 2016', 'Social Media Manager', 'Purdue University Triathlon Club', 
) %>% 
...
```{r}
  ...
  'Aug 2018', 'Ironman 70.3 Steelhead Triathlon', 'MI',
  'Aug 2017', 'Ironman 70.3 Steelhead Triathlon', 'MI',
  'Apr 2017', 'USA Triathlon Collegiate Club National Championships', 'Tuscaloosa, AL',
  'Nov 2016', 'Monumental Marathon', 'Indianapolis, IN',
  'Aug 2016', 'Ironman 70.3 Steelhead Triathlon', 'MI',
