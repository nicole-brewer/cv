...
tribble(
  ...
  '2022', '', '\\textbf{eScience Travel Grant} (\\$700), NSF', '',
...
tribble( 
 ...
 "Classification of Periodicity in Subtraction Game Sequences", "Poster", "PEARC18", "Pittsburg, PA", 'June 2018', 'https://doi.org/10.5281/zenodo.7133317', '.',
  ...
  brief_entries(glue::glue('\\textbf{<title>} (\\underline{\\href{<format>}{<url>}}), <event>, <place> <additional>', .open = "<", .close = ">"), date, .protect = FALSE)
```
...
```{r}
tribble(
  ~Activity, ~Role, ~Conference, ~Location, ~When, ~Link, ~Type,
 'Reproducibility Challenge Committee', 'Member', 'Supercomputing', 'Dallas, TX',  'Nov 2022', 
 'https://se4science.org/workshops/se4escience22/schedule.htm', 'link',
   "Software Engineering Topics Relevant to eScience", "Invited Panelist", "eScience", "Salt Lake City, UT", "Oct 2022", 
 "https://us-rse.org/events/2021/2021-10-intnl-rse-day", 'link',
  "How to Recruit and Sustain a Diverse and Inclusive Workforce: A Case Study",  "Invited Panelist", "International RSE Day Virtual Workshop", "Virtual", "Oct 2021", 'https://doi.org/10.5281/zenodo.7133472', 'slides'
) %>% 
  brief_entries(glue::glue('\\textbf{<Role>}, <Activity>, (\\underline{\\href{<Link>}{<Type>}}).', .open = "<", .close = ">"), When, Conference, .protect = FALSE)
...
tribble(
 ...
 'https://nicole-brewer.github.io/long-tales-of-science/002/', 'episode'
   ...
   brief_entries(glue::glue('\\textbf{<title>} (<type>), <event>, <place>, (\\underline{\\href{<url>}{<format>}}).', .open = "<", .close = ">"), date, .protect = FALSE)
```
