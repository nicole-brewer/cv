...
tribble(
  ...
  'July 2019', 'Applied Management Principles', 'Krannert Executive Education', 'Purdue University', list('A "mini-MBA" covering accounting, finance, strategy, marketing, negotiations & problem solving, and \\newline entrepreneurial skills essential to effective laboratory and research project managment')
) %>% 
