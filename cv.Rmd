...
tribble( 
 ~ title, ~ type, ~ url,
 'Corpus Creation with Scopus (in progress)', 'Binder', 'https://www.nicole-brewer.com/corpus_creation_with_scopus',
 "R for Research Scientists", "Booklet", 'https://www.nicole-brewer.com/r-for-research-scientists/'
 ) %>% 
  brief_entries(glue::glue('\\textbf{<title>}, \\url{<url>}', .open = "<", .close = ">"), type, .protect = FALSE)
```
