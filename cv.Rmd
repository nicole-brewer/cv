...
tribble(
  ...
  "PhD Computational History and Philosophy of Science", "Expected May 2027", "Arizona State University", "Tempe, AZ", c("Using natural language processing, network analysis, agent-based modeling, and high performance computing (HPC) to better understand how scientific standards of practice are motivated by reproducibility and other values"),
