...
tribble( 
 ...
 "Software Engineering Topics Relevant to eScience", "Invited Panelist", "eScience 2022", "Salt Lake City, UT", "Oct 2022", 'https://se4science.org/workshops/se4escience22/schedule.htm',
 'Scientific Web Applications Template', 'Speaker', 'US-RSE Community Call', 'Virtual', 'March 2022',
 ...
 "Leveraging Traits for Highly Interactive Computational Tools in Jupyter", "Abstract, Video Presentation", "Gateways 2021", "Virtual", 'July 2021', "https://doi.org/10.5281/zenodo.5570605",
 "Classification of Periodicity in Subtraction Game Sequences", "Poster", "PEARC18", "Pittsburg, PA", 'June 2018', 'https://doi.org/10.5281/zenodo.7133317'
  ...
  brief_entries(glue::glue('\\textbf{<title>} (\\underline{\\href{<url>}{<type>}}), <event>, <place>', .open = "<", .close = ">"), date, .protect = FALSE)
```
...
tribble(
 ...
 '\\url{http://us-rse.org/rse-stories/posts/}',
...
tribble( 
 ~ title, ~ type, ~ url,
 'Corpus Creation with Scopus (in progress)', 'Binder', 'https://mybinder.org/v2/gh/nicole-brewer/corpus_creation_with_scopus/HEAD',
 "R for Research Scientists", "Booklet", 'https://www.nicole-brewer.com/r-for-research-scientists/'
 ) %>% 
  brief_entries(glue::glue('\\textbf{<title>}, \\url{<url>}', .open = "<", .close = ">"),paste0(type, "\\newline"), .protect = FALSE)
```
