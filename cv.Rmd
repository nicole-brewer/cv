...
tribble(
 ...
 'Better Scientific Software Fellowship', 'Awardee', 'Up to \\$25,000', 'Exascale Computing Project (DOE/NSF)', 'Jan 2023',
...
tribble( 
 ~ title, ~ format, ~ event, ~ place, ~ date, ~ url, ~ additional, 
   'Scientific Web Applications Template', 'presenter', 'Mini Gateways 2022', 'Virtual', 'Mar 2022',
 'https://doi.org/10.5281/zenodo.7133296', '',
...
<!-- # Interactive Notebooks and Scientific Web Applications -->
...
tribble(
  ...
  'United States Research Software Engineering Association', 'Booth Event Coordinator', 'SC22', 'Dallas, TX', 'Nov 2022', '',
 'Reproducibility Challenge', 'Committee Member', 'SC22', 'Dallas, TX',  'Nov 2022', '', 
  ...
  "How to Recruit and Sustain a Diverse and Inclusive Workforce: A Case Study",  "Invited Panelist", "Int'l RSE Day", "Virtual", "Oct 2021", '(\\underline{\\href{https://doi.org/10.5281/zenodo.7133472}{slides}})',
) %>% 
...
tribble(
  ...
  'Jan 2022 - Present', 'Council Member', 'International Council of RSE Association', "Int'l", 
...
```{r} 
  tribble(
  ~Date, ~Role, ~Program,
  '2023', 'Reviewer', 'GPSA Travel Grant Program',
...
tribble( 
 ...
 #'Corpus Creation with Scopus (in progress)', 'binder', 'Aug 2022', 'https://mybinder.org/v2/gh/nicole-brewer/corpus_creation_with_scopus/HEAD',
...
tribble(
 ...
 'Reproducibility Initiative at SC22', 'Host', 'Long Tales of Science', 'Podcast', 'Jan 2023', 'https://nicole-brewer.github.io/long-tales-of-science/005/', 'episode',
