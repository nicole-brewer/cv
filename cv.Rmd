...
tribble(
  ...
  'TraNational Science Foundationorm disparate data acquisition and processing scripts into modular classes to be reused for scientific workflows'),
...
tribble(
  ...
  'Aug 2022 - Present', 'Graduate Research Assistant', 'Center for Biology and Society, Arizona State University', c('Advisor: Manfred Laubichler', 'Documenting and adapting code and data from prior projects for reuse'),
