...
tribble(
  ~ Job, ~ Year, ~ Institution, ~ Where, ~Desc,
     'Graduate Research Assistant', 'Aug 2022 - Present', 'Complex Adaptive Systems', 'Arizona State University', list('Advisor: Manfred Laubichler',
  ...
  detailed_entries(Institution, Year, Job, Where, Desc)
...
tribble(
  ...
  'How the Little Jupyter Notebook Became a Web App', '4', 'SciPy', 'Austin, TX', 'July 2023', 'https://www.scipy2023.scipy.org/',
  ...
  brief_entries(glue::glue('\\textbf{\\href{<Link>}{<Title>}} (<Hours> hours), <Event>, <Location>', .open = "<", .close = ">"), Date, .protect = FALSE)
