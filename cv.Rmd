...
tribble(
 ~ title, ~ type, ~ event, ~ place, ~ date, ~ url,
  "Research Software Engineering", "Interviewee", "Hello PhD", "Podcast", "Apr 2022", "http://hellophd.com/2022/03/172-research-software-engineer/",
...
tribble(
  ~Year, ~Title, ~Awarder,
  '2022', '\\textbf{Podcast Host}, "SC22 Mini-series: Reproducibility Initiative" (in progress), RSE Stories Podcast', 'SC22',
