...
tribble(
  ...
  c('created an interactive lesson about parallel and distributed computing', 'modified existing lesson for remote instruction', 'leanred teaching practices that support inclusion'), 
