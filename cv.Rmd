...
tribble(
  ...
  '2022', '', 'School of Life Science Fellowship, Arizona State University', '',
  '2021', "Travel support for early career scholars who are considering pursuing philosophy of science", 'UPSS Delegate, Philosophy of Science Biennial Meeting', '',
  '2020', "Honorarium awarded for notable achievement in the advancement of science gateways", 'Young Professional of the Year, Science Gateways Community Institute', '',
  '2018', 'Travel support to attend PEARC18 and participate in the student program', 'Travel Grant, XSEDE', '',
  '2018', 'Awarded for "Classification of Periodicity in Subtraction Game Sequences"', 'Phil Andrews Award, Practice and Experience in Advanced Research Computing Conference', ''
) %>% 
  brief_entries(what=Title, when=Year, with=Awarder)
```
...
```{r}
  tribble(
  ~Date, ~Position, ~Group,
  'Aug 2016 - Aug 2017', 'Vice President', 'Purdue University Triathlon Club', 
   'Aug 2015 - Aug 2016', 'Social Media Manager', 'Purdue University Triathlon Club', 
) %>% 
  brief_entries(what=Position, when=Date, with=Group)
