...
```{r}
# if no additional format, use a '.'
tribble( 
 ~ title, ~ format, ~ event, ~ place, ~ date, ~ url, ~ additional, 
   'Scientific Web Applications Template', 'presentation', 'US-RSE Community Call', 'Virtual', 'Mar 2022',
...
tribble(
 ...
 'Reproducibility Challenge', 'Committee Member', 'SC22', 'Dallas, TX',  'Nov 2022', '', #'https://se4science.org/workshops/se4escience22/schedule.htm',
  ...
  "How to Recruit and Sustain a Diverse and Inclusive Workforce: A Case Study",  "Invited Panelist", "Int'l RSE Day Workshop", "Virtual", "Oct 2021", '(\\underline{\\href{https://doi.org/10.5281/zenodo.7133472}{slides}})',
) %>% 
...
tribble(
 ...
 'Trial by Fire', 'Podcast Host', 'Long Tales of Science', 'Podcast' , 'May 2022',
