...
tribble( 
 ~ title, ~ format, ~ event, ~ place, ~ date, ~ url, ~ additional,
 'Notebooks as Scholarly Objects', 'host', 'US-RSE Comm. Call', 'Virtual', 'Mar 2023',
...
```{r}
tribble(
  ~Title, ~Hours, ~Event, ~Location, ~Date, ~Link, 
  'Notebook Submission Tutorial', '1.5', 'US-RSE', 'Virtual', 'Apr 2023', 'https://us-rse.org/usrse23/2023-03-03-notebook-submission-tutorial',
) %>% 
  brief_entries(glue::glue('\\textbf{<Title>} (\\underline{\\href{<Link>}{<Hours> hours}}), <Event>, <Location>', .open = "<", .close = ">"), Date, .protect = FALSE)
```
\medskip
