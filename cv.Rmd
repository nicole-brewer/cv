...
tribble(
 ...
 "To Be Decided",  "Invited Panelist", "International RSE Day", "Virtual", "Oct 2021", "https://us-rse.org/events/2021/2021-10-intnl-rse-day",
) %>% 
  brief_entries(glue::glue('\\textbf{<title>} (<type>), <event>, <place>.  \\newline \\url{<url>}', .open = "<", .close = ">"), paste0(date, "\\newline"), .protect = FALSE)
```
